    ...
    for itr in range(params['n_iter']):
        ...
        if itr == 0:
            ...
            try:
                ...
                paths, _ = utils.sample_trajectories(env, expert_policy, params["batch_size"], params['ep_len'])
            ...
            if params['do_dagger']:
                ...
                for path in paths:
                    path["action"] = ptu.to_numpy(expert_policy(ptu.from_numpy(path["observation"])))
